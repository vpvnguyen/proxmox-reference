...
# allow VPN connection on PORT 1194
...
iptables -I OUTPUT 1 -p udp --destination-port 22 -m comment --comment "Allow SSH connection" -j ACCEPT
...
echo "done"
echo 'openVPN - Rules successfully applied'
echo 'To verify IPtables in realtime run'
echo ''
echo 'sudo iptables -nvL'
